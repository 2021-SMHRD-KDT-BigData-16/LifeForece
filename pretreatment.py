def Pretreatment(test_df):
    ...
    test_df4 = test_df4.drop(['rec_time'], axis=1)
    ...
    def zero_padding(dataframe, maxlen):
        ...
        basic_col = 'p_id, age, Gender, ICUtype, male, female'
    ...
    test_df5_1 = test_df5.drop(
        columns=['p_id', 'age', 'Gender', 'ICUtype', 'male', 'female'])
